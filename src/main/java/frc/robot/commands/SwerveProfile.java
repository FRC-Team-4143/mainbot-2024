...
public class SwerveProfile extends Command {
  ...
  @Override
  public void execute() {
    SwerveDrivetrain.getInstance().setControl(new SwerveRequest.ApplyChassisSpeeds()
      .withDriveRequestType(SwerveModule.DriveRequestType.Velocity)
      .withSpeeds(new ChassisSpeeds(x_speed_req,y_speed_req,rot_speed_req))); // 3 m/s in x direction (frame relative)
  }

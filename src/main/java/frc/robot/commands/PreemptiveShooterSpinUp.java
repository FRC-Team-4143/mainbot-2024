...
public class PreemptiveShooterSpinUp extends Command {
  /** Creates a new ShootAtTarget. */
  boolean shot_note_;
  public PreemptiveShooterSpinUp() {
  ...
  public void initialize() {
   if (PickupSubsystem.getShooterInstance().hasNote()||ShooterSubsystem.getInstance().hasNote())
   {
      new ShooterSpinUp();
   }
  }
